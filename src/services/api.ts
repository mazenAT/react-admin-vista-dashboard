...
export const adminApi = {
  ...
  getWallets: (params?: any) => 
    api.get('/admin/wallets', { params: addSchoolIdToParams(params) }),
  getDailyRecharges: (params?: any) => 
    api.get('/admin/wallet/daily-recharges', { params: addSchoolIdToParams(params) }),
